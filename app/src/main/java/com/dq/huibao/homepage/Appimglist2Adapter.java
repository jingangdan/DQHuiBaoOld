...
public class Appimglist2Adapter extends RecyclerView.Adapter<Appimglist2Adapter.MyViewHolder> {
    private Context mContext;
    private List<Index2.DataBean.AppimglistBean> appimgList;
    private OnItemClickListener onItemClickListener;

    public Appimglist2Adapter(Context mContext, List<Index2.DataBean.AppimglistBean> appimgList) {
