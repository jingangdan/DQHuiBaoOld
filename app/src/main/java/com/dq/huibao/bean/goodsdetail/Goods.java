...
public class Goods {
    ...
    public void setCommission1Rate(String commission1Rate) {
    ...
    public void setCommission1Pay(String commission1Pay) {
    ...
    public void setCommission2Rate(String commission2Rate) {
    ...
    public void setCommission2Pay(String commission2Pay) {
    ...
    public void setCommission3Rate(String commission3Rate) {
    ...
    public void setCommission3Pay(String commission3Pay) {
    ...
    public void setLoveMoney(String loveMoney) {
    ...
    public void setYunbiConsumption(String yunbiConsumption) {
        this.yunbiConsumption = yunbiConsumption;
    }
    public String getYunbiConsumption() {
        return yunbiConsumption;
    }

    public void setYunbiCommission(String yunbiCommission) {
        this.yunbiCommission = yunbiCommission;
    }
    public String getYunbiCommission() {
        return yunbiCommission;
    }
    ...
    public void setYunbiDeduct(String yunbiDeduct) {
        this.yunbiDeduct = yunbiDeduct;
    }
    ...
    public void setVirtualDeclaration(String virtualDeclaration) {
        this.virtualDeclaration = virtualDeclaration;
    }
    public String getVirtualDeclaration() {
        return virtualDeclaration;
    }

    public void setGoodsBalance(String goodsBalance) {
    ...
    public void setBalanceWithStore(String balanceWithStore) {
        this.balanceWithStore = balanceWithStore;
    }
    public String getBalanceWithStore() {
        return balanceWithStore;
    }
