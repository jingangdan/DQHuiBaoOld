...
public class HotClassifyAdapter1 extends RecyclerView.Adapter<HotClassifyAdapter1.MyViewHolder> {
    ...
    public HotClassifyAdapter1(Context mContext){
...
//        }
        ...
        holder.img.setImageResource(R.mipmap.ic_hot002);
